...
In this repository we're collecting replications for the key experiments in the *Adversarial vulnerability of powerful near out-of-distribution detection* paper by [Stanislav Fort](https://scholar.google.com/citations?user=eu2Kzn0AAAAJ&hl=en).
